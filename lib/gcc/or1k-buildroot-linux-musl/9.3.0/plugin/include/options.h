...
#define MASK_SOFT_DIV (1U << 1)
#define MASK_SOFT_MUL (1U << 2)
#define MASK_ROR (1U << 3)
#define MASK_SEXT (1U << 4)
#define MASK_SFIMM (1U << 5)
#define MASK_SHFTIMM (1U << 6)
...
enum opt_code
{
  ...
  OPT_mbionic = 1274,                        /* -mbionic */
  OPT_mcmov = 1275,                          /* -mcmov */
  OPT_mglibc = 1276,                         /* -mglibc */
  OPT_mhard_div = 1277,                      /* -mhard-div */
  OPT_mhard_mul = 1278,                      /* -mhard-mul */
  OPT_mmusl = 1279,                          /* -mmusl */
  OPT_mror = 1280,                           /* -mror */
  OPT_msext = 1281,                          /* -msext */
  OPT_msfimm = 1282,                         /* -msfimm */
  OPT_mshftimm = 1283,                       /* -mshftimm */
  OPT_msoft_div = 1284,                      /* -msoft-div */
  OPT_msoft_mul = 1285,                      /* -msoft-mul */
  OPT_muclibc = 1286,                        /* -muclibc */
  OPT_n = 1287,                              /* -n */
  OPT_no_canonical_prefixes = 1288,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1289,              /* -no-integrated-cpp */
  OPT_no_pie = 1290,                         /* -no-pie */
  OPT_nocpp = 1291,                          /* -nocpp */
  OPT_nodefaultlibs = 1292,                  /* -nodefaultlibs */
  OPT_nolibc = 1293,                         /* -nolibc */
  OPT_nophoboslib = 1294,                    /* -nophoboslib */
  ...
  OPT_shared_libphobos = 1330,               /* -shared-libphobos */
  ...
  OPT_static_libgfortran = 1336,             /* -static-libgfortran */
  OPT_static_libgo = 1337,                   /* -static-libgo */
  OPT_static_liblsan = 1338,                 /* -static-liblsan */
  OPT_static_libmpx = 1339,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1340,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1341,               /* -static-libphobos */
  OPT_static_libstdc__ = 1342,               /* -static-libstdc++ */
  OPT_static_libtsan = 1343,                 /* -static-libtsan */
  OPT_static_libubsan = 1344,                /* -static-libubsan */
  OPT_static_pie = 1345,                     /* -static-pie */
  /* OPT_std_c__03 = 1346, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1347, */                /* -std=c++0x */
  OPT_std_c__11 = 1348,                      /* -std=c++11 */
  OPT_std_c__14 = 1349,                      /* -std=c++14 */
  OPT_std_c__17 = 1350,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1351, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1352, */                /* -std=c++1z */
  OPT_std_c__2a = 1353,                      /* -std=c++2a */
  OPT_std_c__98 = 1354,                      /* -std=c++98 */
  OPT_std_c11 = 1355,                        /* -std=c11 */
  OPT_std_c17 = 1356,                        /* -std=c17 */
  /* OPT_std_c18 = 1357, */                  /* -std=c18 */
  /* OPT_std_c1x = 1358, */                  /* -std=c1x */
  OPT_std_c2x = 1359,                        /* -std=c2x */
  ...
  /* OPT_std_iso9899_2017 = 1393, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1394, */         /* -std=iso9899:2018 */
