...
extern int reg_or_u6_operand (rtx, machine_mode);
...
extern int high_operand (rtx, machine_mode);
extern int losum_add_operand (rtx, machine_mode);
extern int losum_ior_operand (rtx, machine_mode);
extern int virtual_frame_reg_operand (rtx, machine_mode);
