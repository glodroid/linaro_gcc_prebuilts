...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/or1k-buildroot-linux-musl/sysroot")
set(CMAKE_FIND_ROOT_PATH "${RELOCATED_HOST_DIR}/or1k-buildroot-linux-musl/sysroot")
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(ENV{PKG_CONFIG_SYSROOT_DIR} "${RELOCATED_HOST_DIR}/or1k-buildroot-linux-musl/sysroot")

# This toolchain file can be used both inside and outside Buildroot.
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/or1k-buildroot-linux-musl-gcc")
set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/or1k-buildroot-linux-musl-g++")
if(1)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/or1k-buildroot-linux-musl-gfortran")
endif()
